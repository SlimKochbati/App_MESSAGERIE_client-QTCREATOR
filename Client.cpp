    ...
    , tcpSocket(new QTcpSocket(this))
{
    ...
    connect(sendMessageButton, &QPushButton::clicked, this, &Client::sendMessageToServer); //cliquer sur Envoyer appelle sendMessageToServer.
    sendMessageButton->setStyleSheet("background-color: blue; color: white;");  // Ajout du fond bleu et du texte en blanc
    connectButton->setStyleSheet("background-color: green; color: white;");  // Ajout du fond bleu et du texte en blanc
    ...
    setStyleSheet("QWidget {"
                  ...
                  "font-family: Courier New;"            // Police utilisée
                  "}"
                  "QPushButton {"
                  ...
                  "border: 1px solid #666666;"     // Bordure des champs de texte
...
void Client::setupUi() {
    ...
    auto hostLabel = new QLabel(tr("IP Serveur:"));
    ...
    mainLayout->addWidget(new QLabel(tr("Tapez un message :"))); // Ajoute le label pour envoyer un message.
    ...
    mainLayout->addWidget(new QLabel(tr("Chat :"))); // Ajoute le label "Messages".
